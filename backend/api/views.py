...
from api.models import StaffUser,Project,ProjectFinancePart,Partner,Translation,Department,PhaseType, ChatMessage,ProjectGipPart,ActionLog,WorkOrder,WorkOrderFile,JobPosition,UserTask,ChatMessageFile
...
class StaffUserUpdateAPIView(APIView):
    ...
    def patch(self, request, user_id):
        ...
        # ✅ Handle basic text fields (excluding 'position')
        for field in ['fio', 'phone_number', 'address', 'pnfl']:
            value = request.data.get(field)
            if value is not None:
                setattr(staff, field, value)

        # ✅ Handle 'position' as ForeignKey
...
class JobPositionUpdateView(UpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        # ✅ Ignore current instance when checking duplicates
...
class ChatMessageSendView(APIView):
    ...
    def post(self, request):
        ...
        # 🔎 Get task and validate permission
        task = get_object_or_404(UserTask, pk=task_id)
        if user != task.create_user and user != task.receiver:
...
class ChatMessageSendFileView(APIView):
    ...
    def post(self, request):
        ...
        # 💬 Create ChatMessage with optional message
        ...
        return Response({'status': 'success', 'message': '✅ Files sent successfully.'}, status=status.HTTP_201_CREATED)
